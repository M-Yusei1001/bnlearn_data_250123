...
#データ読み込み,処理
product <- read.csv("~/rscripts/data/250128/data_products_20250128.csv")
product <- as.data.frame(lapply(product, factor))

states <- read.csv("~/rscripts/data/250128/data_states_20250128.csv")
states <- states$states

incidents <- read.csv("~/rscripts/data/250128/data_incidents_20250128.csv")
incidents <- incidents$incidents

causes <- read.csv("~/rscripts/data/250128/data_causes_20250128.csv")
...
# DOT言語のファイルを出力
write.dot("~/rscripts/output/data_250128.dot", fitted)
