...
#データ読み込み,処理
product <- read.csv("~/rscripts/data/250124_5/data_products_20250124.csv")
product <- as.data.frame(lapply(product, factor))

states <- read.csv("~/rscripts/data/250124_5/data_states_20250124.csv")
states <- states$states

incidents <- read.csv("~/rscripts/data/250124_5/data_incidents_20250124.csv")
incidents <- incidents$incidents

causes <- read.csv("~/rscripts/data/250124_5/data_causes_20250124.csv")
...
# DOT言語のファイルを出力
write.dot("~/rscripts/output/data_250124_5.dot", fitted)
