...
#データ読み込み,処理
product <- read.csv("~/rscripts/data/250127_cat/data_products_20250127_cat.csv")
product <- as.data.frame(lapply(product, factor))

states <- read.csv("~/rscripts/data/250127_cat/data_states_20250127_cat.csv")
states <- states$states

incidents <- read.csv("~/rscripts/data/250127_cat/data_incidents_20250127_cat.csv")
incidents <- incidents$incidents

causes <- read.csv("~/rscripts/data/250127_cat/data_causes_20250127_cat.csv")
...
# DOT言語のファイルを出力
write.dot("~/rscripts/output/data_250127_cat.dot", fitted)
